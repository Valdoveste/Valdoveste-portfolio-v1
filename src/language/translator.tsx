const translator = ({
    PortugueseBr: {
        ...
        paragraph: [
            ...
            'Sempre fui atraído por projetos de longa duração, onde efetivamente posso produzir e acompanhar cada processo de seu desenvolvimento. Tenho como objetivo de carreira trabalhar no desenvolvimento FrontEND, assim podem colocar em prática as habilidades que adquiri.',
    ...
    EnglishUs: {
        ...
        paragraph: [
            ...
            'Always looking to develop my skills in building projects for the WEB.',
            ...
            `I've always been attracted to long-term projects, where I can effectively produce and monitor each development process.  My career goal is to work in FrontEND development, so they can put the skills I've acquired into practice.`,

            `Stay on top of the technologies I'm using recently, as well as some others I'm learning.`,

            `Thanks for getting here. I'm open to opportunities, so if you have any questions or would like to say "Hi", feel free to contact me.`
        ],
