const PortfolioSmallCards = [
    {
        ...
        project_git_url: "https://github.com/Valdoveste/rotmgex-target-creator",
        project_img_alt: "RotmgTargetCreator Project Image",
        project_desc: "Facilitator for those that have mules and have no patience to create write target in base64.",
        project_tech: ["HTML5", "CSS3", "JS"],
        animation_delay: {
    ...
    },
    {
        ...
        project_git_url: "https://github.com/Batatinha-s-Hardware/batatinhas-hardware",
        project_img_alt: "BatatinhasHardware Project Image",
...
export default PortfolioSmallCards;
